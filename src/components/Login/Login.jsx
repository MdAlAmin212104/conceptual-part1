            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-900 text-gray-50 mx-auto mt-10">
                  ...
                  <form onSubmit={handleLoginSubmit} className="space-y-6">
                        ...
                        <div className="space-y-1 text-sm">
                              ...
                              <div className="flex justify-end text-xs text-gray-60">
                  ...
                  <div className="flex items-center pt-4 space-x-1">
                        ...
                        <p className="px-3 text-sm text-gray-60">Login with social accounts</p>
                        <div className="flex-1 h-px sm:w-16 bg-gray-300"></div>
                  </div>
                  ...
                  <p className="text-xs text-center sm:px-6 dark:text-gray-600">Don't have an account?
                        <Link to="/register" rel="noopener noreferrer" className="underline dark:text-gray-800">Sign up</Link>
                  </p>
            </div>
      );
};
